      ...
      <header className="header">
        ...
        <nav className="navbar">
          <div className="content-navbar">
            <div className="text">
              <p> Welcome to L-IT TRULY SERVICES PVT LTD</p>
            </div>
            <ul className="nav-list">
              ...
              <li className="nav-item">
                ...
                <ul className="dropdown-list">
                  <li className="list-items1">
                    <Link to={"/home/assetsRegistration"}>Registration</Link>
                  </li>
                  <li className="list-items2">Search</li>
                  <li className="list-items3">Management</li>
                </ul>
              </li>
              <li className="nav-item">
                CO-W Lap
